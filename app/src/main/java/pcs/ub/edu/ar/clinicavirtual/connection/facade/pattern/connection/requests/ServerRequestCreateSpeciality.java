...
import pcs.ub.edu.ar.clinicavirtual.connection.facade.pattern.connection.uri.ServerRequestPatient;
...
public class ServerRequestCreateSpeciality extends ServerRequestSpeciality {
    @Override
