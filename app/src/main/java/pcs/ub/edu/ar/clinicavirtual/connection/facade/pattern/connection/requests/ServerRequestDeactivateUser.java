...
import pcs.ub.edu.ar.clinicavirtual.connection.facade.pattern.connection.uri.ServerRequestDeactivate;
...
public class ServerRequestDeactivateUser extends ServerRequestDeactivate {
    @Override
