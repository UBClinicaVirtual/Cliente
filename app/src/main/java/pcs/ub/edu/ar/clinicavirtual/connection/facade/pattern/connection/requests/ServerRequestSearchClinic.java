...
import pcs.ub.edu.ar.clinicavirtual.connection.facade.pattern.connection.uri.ServerRequestClinic;
...
public class ServerRequestSearchClinic extends ServerRequestClinic {
    @Override
